...
type CiBuildRunRelationships struct {
	...
	Actions *AnalyticsReportInstanceRelationshipsSegments `json:"actions,omitempty"`
...
// SetActions gets a reference to the given AnalyticsReportInstanceRelationshipsSegments and assigns it to the Actions field.
