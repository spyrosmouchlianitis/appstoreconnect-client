...
type _AppEventCreateRequestDataAttributes AppEventCreateRequestDataAttributes
...
func (o *AppEventCreateRequestDataAttributes) UnmarshalJSON(data []byte) (err error) {
	...
	varAppEventCreateRequestDataAttributes := _AppEventCreateRequestDataAttributes{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAppEventCreateRequestDataAttributes)

	if err != nil {
		return err
	}

	*o = AppEventCreateRequestDataAttributes(varAppEventCreateRequestDataAttributes)
