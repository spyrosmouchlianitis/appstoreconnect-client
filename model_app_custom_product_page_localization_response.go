...
type _AppCustomProductPageLocalizationResponse AppCustomProductPageLocalizationResponse
...
func (o *AppCustomProductPageLocalizationResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varAppCustomProductPageLocalizationResponse := _AppCustomProductPageLocalizationResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAppCustomProductPageLocalizationResponse)

	if err != nil {
		return err
	}

	*o = AppCustomProductPageLocalizationResponse(varAppCustomProductPageLocalizationResponse)
