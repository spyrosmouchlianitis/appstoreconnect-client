...
type _AppClipAdvancedExperienceRelationshipsAppClipData AppClipAdvancedExperienceRelationshipsAppClipData
...
func (o *AppClipAdvancedExperienceRelationshipsAppClipData) UnmarshalJSON(data []byte) (err error) {
	...
	varAppClipAdvancedExperienceRelationshipsAppClipData := _AppClipAdvancedExperienceRelationshipsAppClipData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAppClipAdvancedExperienceRelationshipsAppClipData)

	if err != nil {
		return err
	}

	*o = AppClipAdvancedExperienceRelationshipsAppClipData(varAppClipAdvancedExperienceRelationshipsAppClipData)
