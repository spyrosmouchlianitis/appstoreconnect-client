...
type _ReviewSubmissionItemUpdateRequest ReviewSubmissionItemUpdateRequest
...
func (o *ReviewSubmissionItemUpdateRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varReviewSubmissionItemUpdateRequest := _ReviewSubmissionItemUpdateRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varReviewSubmissionItemUpdateRequest)

	if err != nil {
		return err
	}

	*o = ReviewSubmissionItemUpdateRequest(varReviewSubmissionItemUpdateRequest)
