...
type _SubscriptionOfferCodeCustomCodeResponse SubscriptionOfferCodeCustomCodeResponse
...
func (o *SubscriptionOfferCodeCustomCodeResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varSubscriptionOfferCodeCustomCodeResponse := _SubscriptionOfferCodeCustomCodeResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSubscriptionOfferCodeCustomCodeResponse)

	if err != nil {
		return err
	}

	*o = SubscriptionOfferCodeCustomCodeResponse(varSubscriptionOfferCodeCustomCodeResponse)
