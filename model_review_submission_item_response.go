...
type _ReviewSubmissionItemResponse ReviewSubmissionItemResponse
...
func (o *ReviewSubmissionItemResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varReviewSubmissionItemResponse := _ReviewSubmissionItemResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varReviewSubmissionItemResponse)

	if err != nil {
		return err
	}

	*o = ReviewSubmissionItemResponse(varReviewSubmissionItemResponse)
