...
type _SubscriptionAvailabilityCreateRequest SubscriptionAvailabilityCreateRequest
...
func (o *SubscriptionAvailabilityCreateRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varSubscriptionAvailabilityCreateRequest := _SubscriptionAvailabilityCreateRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSubscriptionAvailabilityCreateRequest)

	if err != nil {
		return err
	}

	*o = SubscriptionAvailabilityCreateRequest(varSubscriptionAvailabilityCreateRequest)
