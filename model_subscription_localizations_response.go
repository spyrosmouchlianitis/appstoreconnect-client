...
type _SubscriptionLocalizationsResponse SubscriptionLocalizationsResponse
...
func (o *SubscriptionLocalizationsResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varSubscriptionLocalizationsResponse := _SubscriptionLocalizationsResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSubscriptionLocalizationsResponse)

	if err != nil {
		return err
	}

	*o = SubscriptionLocalizationsResponse(varSubscriptionLocalizationsResponse)
