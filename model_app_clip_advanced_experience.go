...
type _AppClipAdvancedExperience AppClipAdvancedExperience
...
func (o *AppClipAdvancedExperience) UnmarshalJSON(data []byte) (err error) {
	...
	varAppClipAdvancedExperience := _AppClipAdvancedExperience{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAppClipAdvancedExperience)

	if err != nil {
		return err
	}

	*o = AppClipAdvancedExperience(varAppClipAdvancedExperience)
