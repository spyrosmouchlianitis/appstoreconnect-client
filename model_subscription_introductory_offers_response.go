...
type _SubscriptionIntroductoryOffersResponse SubscriptionIntroductoryOffersResponse
...
func (o *SubscriptionIntroductoryOffersResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varSubscriptionIntroductoryOffersResponse := _SubscriptionIntroductoryOffersResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSubscriptionIntroductoryOffersResponse)

	if err != nil {
		return err
	}

	*o = SubscriptionIntroductoryOffersResponse(varSubscriptionIntroductoryOffersResponse)
