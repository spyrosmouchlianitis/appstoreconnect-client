...
func (o *ErrorResponseErrorsInner) UnmarshalJSON(data []byte) (err error) {
	...
	varErrorResponseErrorsInner := _ErrorResponseErrorsInner{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varErrorResponseErrorsInner)

	if err != nil {
		return err
	}

	*o = ErrorResponseErrorsInner(varErrorResponseErrorsInner)
