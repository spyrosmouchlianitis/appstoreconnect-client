...
type _GameCenterLeaderboardsResponse GameCenterLeaderboardsResponse
...
func (o *GameCenterLeaderboardsResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varGameCenterLeaderboardsResponse := _GameCenterLeaderboardsResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGameCenterLeaderboardsResponse)

	if err != nil {
		return err
	}

	*o = GameCenterLeaderboardsResponse(varGameCenterLeaderboardsResponse)
