...
type _AppCustomProductPageVersionResponse AppCustomProductPageVersionResponse
...
func (o *AppCustomProductPageVersionResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varAppCustomProductPageVersionResponse := _AppCustomProductPageVersionResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAppCustomProductPageVersionResponse)

	if err != nil {
		return err
	}

	*o = AppCustomProductPageVersionResponse(varAppCustomProductPageVersionResponse)
