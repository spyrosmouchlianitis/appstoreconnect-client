...
func (o *BuildRelationshipsBetaAppReviewSubmissionData) UnmarshalJSON(data []byte) (err error) {
	...
	err = decoder.Decode(&varBuildRelationshipsBetaAppReviewSubmissionData)
