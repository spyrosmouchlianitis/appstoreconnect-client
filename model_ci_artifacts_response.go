...
type _CiArtifactsResponse CiArtifactsResponse
...
func (o *CiArtifactsResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varCiArtifactsResponse := _CiArtifactsResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCiArtifactsResponse)

	if err != nil {
		return err
	}

	*o = CiArtifactsResponse(varCiArtifactsResponse)
