...
type _AppEventVideoClipsResponse AppEventVideoClipsResponse
...
func (o *AppEventVideoClipsResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varAppEventVideoClipsResponse := _AppEventVideoClipsResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAppEventVideoClipsResponse)

	if err != nil {
		return err
	}

	*o = AppEventVideoClipsResponse(varAppEventVideoClipsResponse)
