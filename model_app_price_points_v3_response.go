...
type _AppPricePointsV3Response AppPricePointsV3Response
...
func (o *AppPricePointsV3Response) UnmarshalJSON(data []byte) (err error) {
	...
	varAppPricePointsV3Response := _AppPricePointsV3Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAppPricePointsV3Response)

	if err != nil {
		return err
	}

	*o = AppPricePointsV3Response(varAppPricePointsV3Response)
