...
type _CiProductResponse CiProductResponse
...
func (o *CiProductResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varCiProductResponse := _CiProductResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCiProductResponse)

	if err != nil {
		return err
	}

	*o = CiProductResponse(varCiProductResponse)
