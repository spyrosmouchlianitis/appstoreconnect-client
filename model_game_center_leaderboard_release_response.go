...
type _GameCenterLeaderboardReleaseResponse GameCenterLeaderboardReleaseResponse
...
func (o *GameCenterLeaderboardReleaseResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varGameCenterLeaderboardReleaseResponse := _GameCenterLeaderboardReleaseResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGameCenterLeaderboardReleaseResponse)

	if err != nil {
		return err
	}

	*o = GameCenterLeaderboardReleaseResponse(varGameCenterLeaderboardReleaseResponse)
