...
type _BetaAppClipInvocationLocalizationInlineCreate BetaAppClipInvocationLocalizationInlineCreate
...
func (o *BetaAppClipInvocationLocalizationInlineCreate) UnmarshalJSON(data []byte) (err error) {
	...
	varBetaAppClipInvocationLocalizationInlineCreate := _BetaAppClipInvocationLocalizationInlineCreate{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varBetaAppClipInvocationLocalizationInlineCreate)

	if err != nil {
		return err
	}

	*o = BetaAppClipInvocationLocalizationInlineCreate(varBetaAppClipInvocationLocalizationInlineCreate)
