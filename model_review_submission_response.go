...
type _ReviewSubmissionResponse ReviewSubmissionResponse
...
func (o *ReviewSubmissionResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varReviewSubmissionResponse := _ReviewSubmissionResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varReviewSubmissionResponse)

	if err != nil {
		return err
	}

	*o = ReviewSubmissionResponse(varReviewSubmissionResponse)
