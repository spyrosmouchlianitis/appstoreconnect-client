...
type _SubscriptionPromotionalOfferPrice SubscriptionPromotionalOfferPrice
...
func (o *SubscriptionPromotionalOfferPrice) UnmarshalJSON(data []byte) (err error) {
	...
	varSubscriptionPromotionalOfferPrice := _SubscriptionPromotionalOfferPrice{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSubscriptionPromotionalOfferPrice)

	if err != nil {
		return err
	}

	*o = SubscriptionPromotionalOfferPrice(varSubscriptionPromotionalOfferPrice)
