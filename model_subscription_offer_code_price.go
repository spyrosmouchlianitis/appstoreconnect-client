...
type _SubscriptionOfferCodePrice SubscriptionOfferCodePrice
...
func (o *SubscriptionOfferCodePrice) UnmarshalJSON(data []byte) (err error) {
	...
	varSubscriptionOfferCodePrice := _SubscriptionOfferCodePrice{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSubscriptionOfferCodePrice)

	if err != nil {
		return err
	}

	*o = SubscriptionOfferCodePrice(varSubscriptionOfferCodePrice)
