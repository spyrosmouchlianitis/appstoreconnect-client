...
type _InAppPurchaseAppStoreReviewScreenshotUpdateRequest InAppPurchaseAppStoreReviewScreenshotUpdateRequest
...
func (o *InAppPurchaseAppStoreReviewScreenshotUpdateRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varInAppPurchaseAppStoreReviewScreenshotUpdateRequest := _InAppPurchaseAppStoreReviewScreenshotUpdateRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varInAppPurchaseAppStoreReviewScreenshotUpdateRequest)

	if err != nil {
		return err
	}

	*o = InAppPurchaseAppStoreReviewScreenshotUpdateRequest(varInAppPurchaseAppStoreReviewScreenshotUpdateRequest)
