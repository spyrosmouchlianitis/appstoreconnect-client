...
// checks if the SubscriptionImageCreateRequestData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SubscriptionImageCreateRequestData{}

// SubscriptionImageCreateRequestData struct for SubscriptionImageCreateRequestData
type SubscriptionImageCreateRequestData struct {
...
type _SubscriptionImageCreateRequestData SubscriptionImageCreateRequestData
...
func NewSubscriptionImageCreateRequestData(type_ string, attributes AppClipAdvancedExperienceImageCreateRequestDataAttributes, relationships SubscriptionAppStoreReviewScreenshotCreateRequestDataRelationships) *SubscriptionImageCreateRequestData {
	this := SubscriptionImageCreateRequestData{}
	this.Type = type_
...
func (o SubscriptionImageCreateRequestData) MarshalJSON() ([]byte, error) {
...
func (o SubscriptionImageCreateRequestData) ToMap() (map[string]interface{}, error) {
...
func (o *SubscriptionImageCreateRequestData) UnmarshalJSON(data []byte) (err error) {
	...
	varSubscriptionImageCreateRequestData := _SubscriptionImageCreateRequestData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSubscriptionImageCreateRequestData)

	if err != nil {
		return err
	}

	*o = SubscriptionImageCreateRequestData(varSubscriptionImageCreateRequestData)

	return err
}

type NullableSubscriptionImageCreateRequestData struct {
	value *SubscriptionImageCreateRequestData
	isSet bool
}

func (v NullableSubscriptionImageCreateRequestData) Get() *SubscriptionImageCreateRequestData {
	return v.value
}

func (v *NullableSubscriptionImageCreateRequestData) Set(val *SubscriptionImageCreateRequestData) {
	v.value = val
	v.isSet = true
}

func (v NullableSubscriptionImageCreateRequestData) IsSet() bool {
	return v.isSet
}

func (v *NullableSubscriptionImageCreateRequestData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSubscriptionImageCreateRequestData(val *SubscriptionImageCreateRequestData) *NullableSubscriptionImageCreateRequestData {
	return &NullableSubscriptionImageCreateRequestData{value: val, isSet: true}
}

func (v NullableSubscriptionImageCreateRequestData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSubscriptionImageCreateRequestData) UnmarshalJSON(src []byte) error {
	v.isSet = true
