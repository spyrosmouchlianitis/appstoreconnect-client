...
func (o *AppPriceV2) UnmarshalJSON(data []byte) (err error) {
	...
	varAppPriceV2 := _AppPriceV2{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAppPriceV2)

	if err != nil {
		return err
	}

	*o = AppPriceV2(varAppPriceV2)
