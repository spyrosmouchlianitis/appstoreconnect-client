...
type _BetaAppReviewDetailsResponse BetaAppReviewDetailsResponse
...
func (o *BetaAppReviewDetailsResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varBetaAppReviewDetailsResponse := _BetaAppReviewDetailsResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varBetaAppReviewDetailsResponse)

	if err != nil {
		return err
	}

	*o = BetaAppReviewDetailsResponse(varBetaAppReviewDetailsResponse)
