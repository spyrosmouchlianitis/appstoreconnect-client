...
type _AppClipResponse AppClipResponse
...
func (o *AppClipResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varAppClipResponse := _AppClipResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAppClipResponse)

	if err != nil {
		return err
	}

	*o = AppClipResponse(varAppClipResponse)
