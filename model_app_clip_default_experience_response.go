...
type _AppClipDefaultExperienceResponse AppClipDefaultExperienceResponse
...
func (o *AppClipDefaultExperienceResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varAppClipDefaultExperienceResponse := _AppClipDefaultExperienceResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAppClipDefaultExperienceResponse)

	if err != nil {
		return err
	}

	*o = AppClipDefaultExperienceResponse(varAppClipDefaultExperienceResponse)
