...
type _InAppPurchaseSubmissionResponse InAppPurchaseSubmissionResponse
...
func (o *InAppPurchaseSubmissionResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varInAppPurchaseSubmissionResponse := _InAppPurchaseSubmissionResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varInAppPurchaseSubmissionResponse)

	if err != nil {
		return err
	}

	*o = InAppPurchaseSubmissionResponse(varInAppPurchaseSubmissionResponse)
