...
type _GameCenterAppVersionResponse GameCenterAppVersionResponse
...
func (o *GameCenterAppVersionResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varGameCenterAppVersionResponse := _GameCenterAppVersionResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGameCenterAppVersionResponse)

	if err != nil {
		return err
	}

	*o = GameCenterAppVersionResponse(varGameCenterAppVersionResponse)
