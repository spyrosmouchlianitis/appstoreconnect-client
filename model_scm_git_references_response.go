...
type _ScmGitReferencesResponse ScmGitReferencesResponse
...
func (o *ScmGitReferencesResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varScmGitReferencesResponse := _ScmGitReferencesResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varScmGitReferencesResponse)

	if err != nil {
		return err
	}

	*o = ScmGitReferencesResponse(varScmGitReferencesResponse)
