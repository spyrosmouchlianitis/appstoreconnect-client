...
type _AppClipAppStoreReviewDetailResponse AppClipAppStoreReviewDetailResponse
...
func (o *AppClipAppStoreReviewDetailResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varAppClipAppStoreReviewDetailResponse := _AppClipAppStoreReviewDetailResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAppClipAppStoreReviewDetailResponse)

	if err != nil {
		return err
	}

	*o = AppClipAppStoreReviewDetailResponse(varAppClipAppStoreReviewDetailResponse)
