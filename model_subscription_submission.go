...
type _SubscriptionSubmission SubscriptionSubmission
...
func (o *SubscriptionSubmission) UnmarshalJSON(data []byte) (err error) {
	...
	varSubscriptionSubmission := _SubscriptionSubmission{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSubscriptionSubmission)

	if err != nil {
		return err
	}

	*o = SubscriptionSubmission(varSubscriptionSubmission)
