...
type _AppEventLocalization AppEventLocalization
...
func (o *AppEventLocalization) UnmarshalJSON(data []byte) (err error) {
	...
	varAppEventLocalization := _AppEventLocalization{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAppEventLocalization)

	if err != nil {
		return err
	}

	*o = AppEventLocalization(varAppEventLocalization)
