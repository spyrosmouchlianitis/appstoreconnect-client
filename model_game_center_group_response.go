...
type _GameCenterGroupResponse GameCenterGroupResponse
...
func (o *GameCenterGroupResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varGameCenterGroupResponse := _GameCenterGroupResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGameCenterGroupResponse)

	if err != nil {
		return err
	}

	*o = GameCenterGroupResponse(varGameCenterGroupResponse)
