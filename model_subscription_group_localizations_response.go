...
type _SubscriptionGroupLocalizationsResponse SubscriptionGroupLocalizationsResponse
...
func (o *SubscriptionGroupLocalizationsResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varSubscriptionGroupLocalizationsResponse := _SubscriptionGroupLocalizationsResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSubscriptionGroupLocalizationsResponse)

	if err != nil {
		return err
	}

	*o = SubscriptionGroupLocalizationsResponse(varSubscriptionGroupLocalizationsResponse)
