...
type _SubscriptionGroupSubmissionCreateRequest SubscriptionGroupSubmissionCreateRequest
...
func (o *SubscriptionGroupSubmissionCreateRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varSubscriptionGroupSubmissionCreateRequest := _SubscriptionGroupSubmissionCreateRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSubscriptionGroupSubmissionCreateRequest)

	if err != nil {
		return err
	}

	*o = SubscriptionGroupSubmissionCreateRequest(varSubscriptionGroupSubmissionCreateRequest)
