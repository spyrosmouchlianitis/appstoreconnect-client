...
type _ReviewSubmissionItemCreateRequestData ReviewSubmissionItemCreateRequestData
...
func (o *ReviewSubmissionItemCreateRequestData) UnmarshalJSON(data []byte) (err error) {
	...
	varReviewSubmissionItemCreateRequestData := _ReviewSubmissionItemCreateRequestData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varReviewSubmissionItemCreateRequestData)

	if err != nil {
		return err
	}

	*o = ReviewSubmissionItemCreateRequestData(varReviewSubmissionItemCreateRequestData)
