...
type _CiBuildActionResponse CiBuildActionResponse
...
func (o *CiBuildActionResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varCiBuildActionResponse := _CiBuildActionResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCiBuildActionResponse)

	if err != nil {
		return err
	}

	*o = CiBuildActionResponse(varCiBuildActionResponse)
