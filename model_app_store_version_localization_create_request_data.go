...
func (o *AppStoreVersionLocalizationCreateRequestData) UnmarshalJSON(data []byte) (err error) {
	...
	err = decoder.Decode(&varAppStoreVersionLocalizationCreateRequestData)
