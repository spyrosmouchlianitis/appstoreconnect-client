...
func (o *AppStoreVersionPhasedReleaseUpdateRequestData) UnmarshalJSON(data []byte) (err error) {
	...
	err = decoder.Decode(&varAppStoreVersionPhasedReleaseUpdateRequestData)
