...
type _GameCenterLeaderboardSetsResponse GameCenterLeaderboardSetsResponse
...
func (o *GameCenterLeaderboardSetsResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varGameCenterLeaderboardSetsResponse := _GameCenterLeaderboardSetsResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGameCenterLeaderboardSetsResponse)

	if err != nil {
		return err
	}

	*o = GameCenterLeaderboardSetsResponse(varGameCenterLeaderboardSetsResponse)
