...
type _CiWorkflowUpdateRequestData CiWorkflowUpdateRequestData
...
func (o *CiWorkflowUpdateRequestData) UnmarshalJSON(data []byte) (err error) {
	...
	varCiWorkflowUpdateRequestData := _CiWorkflowUpdateRequestData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCiWorkflowUpdateRequestData)

	if err != nil {
		return err
	}

	*o = CiWorkflowUpdateRequestData(varCiWorkflowUpdateRequestData)
