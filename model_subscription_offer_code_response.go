...
type _SubscriptionOfferCodeResponse SubscriptionOfferCodeResponse
...
func (o *SubscriptionOfferCodeResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varSubscriptionOfferCodeResponse := _SubscriptionOfferCodeResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSubscriptionOfferCodeResponse)

	if err != nil {
		return err
	}

	*o = SubscriptionOfferCodeResponse(varSubscriptionOfferCodeResponse)
