...
type _AppClipHeaderImage AppClipHeaderImage
...
func (o *AppClipHeaderImage) UnmarshalJSON(data []byte) (err error) {
	...
	varAppClipHeaderImage := _AppClipHeaderImage{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAppClipHeaderImage)

	if err != nil {
		return err
	}

	*o = AppClipHeaderImage(varAppClipHeaderImage)
