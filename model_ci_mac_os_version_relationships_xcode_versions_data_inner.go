...
type _CiMacOsVersionRelationshipsXcodeVersionsDataInner CiMacOsVersionRelationshipsXcodeVersionsDataInner
...
func (o *CiMacOsVersionRelationshipsXcodeVersionsDataInner) UnmarshalJSON(data []byte) (err error) {
	...
	varCiMacOsVersionRelationshipsXcodeVersionsDataInner := _CiMacOsVersionRelationshipsXcodeVersionsDataInner{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCiMacOsVersionRelationshipsXcodeVersionsDataInner)

	if err != nil {
		return err
	}

	*o = CiMacOsVersionRelationshipsXcodeVersionsDataInner(varCiMacOsVersionRelationshipsXcodeVersionsDataInner)
