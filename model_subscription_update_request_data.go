...
type _SubscriptionUpdateRequestData SubscriptionUpdateRequestData
...
func (o *SubscriptionUpdateRequestData) UnmarshalJSON(data []byte) (err error) {
	...
	varSubscriptionUpdateRequestData := _SubscriptionUpdateRequestData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSubscriptionUpdateRequestData)

	if err != nil {
		return err
	}

	*o = SubscriptionUpdateRequestData(varSubscriptionUpdateRequestData)
