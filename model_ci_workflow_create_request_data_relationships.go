...
type _CiWorkflowCreateRequestDataRelationships CiWorkflowCreateRequestDataRelationships
...
func (o *CiWorkflowCreateRequestDataRelationships) UnmarshalJSON(data []byte) (err error) {
	...
	varCiWorkflowCreateRequestDataRelationships := _CiWorkflowCreateRequestDataRelationships{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCiWorkflowCreateRequestDataRelationships)

	if err != nil {
		return err
	}

	*o = CiWorkflowCreateRequestDataRelationships(varCiWorkflowCreateRequestDataRelationships)
