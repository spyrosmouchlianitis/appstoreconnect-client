...
type _InAppPurchaseV2 InAppPurchaseV2
...
func (o *InAppPurchaseV2) UnmarshalJSON(data []byte) (err error) {
	...
	varInAppPurchaseV2 := _InAppPurchaseV2{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varInAppPurchaseV2)

	if err != nil {
		return err
	}

	*o = InAppPurchaseV2(varInAppPurchaseV2)
