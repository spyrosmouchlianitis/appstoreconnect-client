...
type _AppPriceScheduleRelationshipsManualPricesDataInner AppPriceScheduleRelationshipsManualPricesDataInner
...
func (o *AppPriceScheduleRelationshipsManualPricesDataInner) UnmarshalJSON(data []byte) (err error) {
	...
	varAppPriceScheduleRelationshipsManualPricesDataInner := _AppPriceScheduleRelationshipsManualPricesDataInner{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAppPriceScheduleRelationshipsManualPricesDataInner)

	if err != nil {
		return err
	}

	*o = AppPriceScheduleRelationshipsManualPricesDataInner(varAppPriceScheduleRelationshipsManualPricesDataInner)
