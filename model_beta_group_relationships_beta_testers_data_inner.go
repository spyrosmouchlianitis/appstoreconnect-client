...
type _BetaGroupRelationshipsBetaTestersDataInner BetaGroupRelationshipsBetaTestersDataInner
...
func (o *BetaGroupRelationshipsBetaTestersDataInner) UnmarshalJSON(data []byte) (err error) {
	...
	varBetaGroupRelationshipsBetaTestersDataInner := _BetaGroupRelationshipsBetaTestersDataInner{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varBetaGroupRelationshipsBetaTestersDataInner)

	if err != nil {
		return err
	}

	*o = BetaGroupRelationshipsBetaTestersDataInner(varBetaGroupRelationshipsBetaTestersDataInner)
