...
type _AppEventScreenshotUpdateRequest AppEventScreenshotUpdateRequest
...
func (o *AppEventScreenshotUpdateRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varAppEventScreenshotUpdateRequest := _AppEventScreenshotUpdateRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAppEventScreenshotUpdateRequest)

	if err != nil {
		return err
	}

	*o = AppEventScreenshotUpdateRequest(varAppEventScreenshotUpdateRequest)
