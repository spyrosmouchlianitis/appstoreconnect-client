...
type _ScmGitReference ScmGitReference
...
func (o *ScmGitReference) UnmarshalJSON(data []byte) (err error) {
	...
	varScmGitReference := _ScmGitReference{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varScmGitReference)

	if err != nil {
		return err
	}

	*o = ScmGitReference(varScmGitReference)
