...
type _BundleIdCapability BundleIdCapability
...
func (o *BundleIdCapability) UnmarshalJSON(data []byte) (err error) {
	...
	varBundleIdCapability := _BundleIdCapability{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varBundleIdCapability)

	if err != nil {
		return err
	}

	*o = BundleIdCapability(varBundleIdCapability)
