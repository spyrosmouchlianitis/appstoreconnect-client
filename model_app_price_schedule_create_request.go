...
type _AppPriceScheduleCreateRequest AppPriceScheduleCreateRequest
...
func (o *AppPriceScheduleCreateRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varAppPriceScheduleCreateRequest := _AppPriceScheduleCreateRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAppPriceScheduleCreateRequest)

	if err != nil {
		return err
	}

	*o = AppPriceScheduleCreateRequest(varAppPriceScheduleCreateRequest)
