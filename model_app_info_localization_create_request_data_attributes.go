...
func (o *AppInfoLocalizationCreateRequestDataAttributes) UnmarshalJSON(data []byte) (err error) {
	...
	err = decoder.Decode(&varAppInfoLocalizationCreateRequestDataAttributes)
