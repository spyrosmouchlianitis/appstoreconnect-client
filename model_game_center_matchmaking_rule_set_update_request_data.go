...
type _GameCenterMatchmakingRuleSetUpdateRequestData GameCenterMatchmakingRuleSetUpdateRequestData
...
func (o *GameCenterMatchmakingRuleSetUpdateRequestData) UnmarshalJSON(data []byte) (err error) {
	...
	varGameCenterMatchmakingRuleSetUpdateRequestData := _GameCenterMatchmakingRuleSetUpdateRequestData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGameCenterMatchmakingRuleSetUpdateRequestData)

	if err != nil {
		return err
	}

	*o = GameCenterMatchmakingRuleSetUpdateRequestData(varGameCenterMatchmakingRuleSetUpdateRequestData)
