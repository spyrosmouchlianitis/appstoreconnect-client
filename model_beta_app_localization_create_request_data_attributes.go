...
type _BetaAppLocalizationCreateRequestDataAttributes BetaAppLocalizationCreateRequestDataAttributes
...
func (o *BetaAppLocalizationCreateRequestDataAttributes) UnmarshalJSON(data []byte) (err error) {
	...
	varBetaAppLocalizationCreateRequestDataAttributes := _BetaAppLocalizationCreateRequestDataAttributes{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varBetaAppLocalizationCreateRequestDataAttributes)

	if err != nil {
		return err
	}

	*o = BetaAppLocalizationCreateRequestDataAttributes(varBetaAppLocalizationCreateRequestDataAttributes)
