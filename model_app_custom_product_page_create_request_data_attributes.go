...
type _AppCustomProductPageCreateRequestDataAttributes AppCustomProductPageCreateRequestDataAttributes
...
func (o *AppCustomProductPageCreateRequestDataAttributes) UnmarshalJSON(data []byte) (err error) {
	...
	varAppCustomProductPageCreateRequestDataAttributes := _AppCustomProductPageCreateRequestDataAttributes{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAppCustomProductPageCreateRequestDataAttributes)

	if err != nil {
		return err
	}

	*o = AppCustomProductPageCreateRequestDataAttributes(varAppCustomProductPageCreateRequestDataAttributes)
