...
type _AppClipDefaultExperience AppClipDefaultExperience
...
func (o *AppClipDefaultExperience) UnmarshalJSON(data []byte) (err error) {
	...
	varAppClipDefaultExperience := _AppClipDefaultExperience{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAppClipDefaultExperience)

	if err != nil {
		return err
	}

	*o = AppClipDefaultExperience(varAppClipDefaultExperience)
