...
func (dst *AppsResponseIncludedInner) UnmarshalJSON(data []byte) error {
	...
	if err == nil {
		...
		if string(jsonAppClip) == "{}" { // empty struct
			...
			if err = validator.Validate(dst.AppClip); err != nil {
				dst.AppClip = nil
			} else {
				match++
			}
	...
	if err == nil {
		...
		if string(jsonAppCustomProductPage) == "{}" { // empty struct
			...
			if err = validator.Validate(dst.AppCustomProductPage); err != nil {
				dst.AppCustomProductPage = nil
			} else {
				match++
			}
	...
	if err == nil {
		...
		if string(jsonAppPreOrder) == "{}" { // empty struct
			...
			if err = validator.Validate(dst.AppPreOrder); err != nil {
				dst.AppPreOrder = nil
			} else {
				match++
			}
	...
	if err == nil {
		...
		if string(jsonBetaAppLocalization) == "{}" { // empty struct
			...
			if err = validator.Validate(dst.BetaAppLocalization); err != nil {
				dst.BetaAppLocalization = nil
			} else {
				match++
			}
	...
	if err == nil {
		...
		if string(jsonBetaAppReviewDetail) == "{}" { // empty struct
			...
			if err = validator.Validate(dst.BetaAppReviewDetail); err != nil {
				dst.BetaAppReviewDetail = nil
			} else {
				match++
			}
	...
	if err == nil {
		...
		if string(jsonBetaLicenseAgreement) == "{}" { // empty struct
			...
			if err = validator.Validate(dst.BetaLicenseAgreement); err != nil {
				dst.BetaLicenseAgreement = nil
			} else {
				match++
			}
	...
	if err == nil {
		...
		if string(jsonEndUserLicenseAgreement) == "{}" { // empty struct
			...
			if err = validator.Validate(dst.EndUserLicenseAgreement); err != nil {
				dst.EndUserLicenseAgreement = nil
			} else {
				match++
			}
	...
	if err == nil {
		...
		if string(jsonGameCenterEnabledVersion) == "{}" { // empty struct
			...
			if err = validator.Validate(dst.GameCenterEnabledVersion); err != nil {
				dst.GameCenterEnabledVersion = nil
			} else {
				match++
			}
	...
	if err == nil {
		...
		if string(jsonInAppPurchase) == "{}" { // empty struct
			...
			if err = validator.Validate(dst.InAppPurchase); err != nil {
				dst.InAppPurchase = nil
			} else {
				match++
			}
	...
	if err == nil {
		...
		if string(jsonInAppPurchaseV2) == "{}" { // empty struct
			...
			if err = validator.Validate(dst.InAppPurchaseV2); err != nil {
				dst.InAppPurchaseV2 = nil
			} else {
				match++
			}
	...
	if err == nil {
		...
		if string(jsonReviewSubmission) == "{}" { // empty struct
			...
			if err = validator.Validate(dst.ReviewSubmission); err != nil {
				dst.ReviewSubmission = nil
			} else {
				match++
			}
	...
	if err == nil {
		...
		if string(jsonSubscriptionGracePeriod) == "{}" { // empty struct
			...
			if err = validator.Validate(dst.SubscriptionGracePeriod); err != nil {
				dst.SubscriptionGracePeriod = nil
			} else {
				match++
			}
