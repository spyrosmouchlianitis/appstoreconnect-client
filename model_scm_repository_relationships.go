...
type ScmRepositoryRelationships struct {
	...
	GitReferences *AnalyticsReportInstanceRelationshipsSegments `json:"gitReferences,omitempty"`
	PullRequests *AnalyticsReportInstanceRelationshipsSegments `json:"pullRequests,omitempty"`
}
...
// GetGitReferences returns the GitReferences field value if set, zero value otherwise.
func (o *ScmRepositoryRelationships) GetGitReferences() AnalyticsReportInstanceRelationshipsSegments {
	if o == nil || IsNil(o.GitReferences) {
		var ret AnalyticsReportInstanceRelationshipsSegments
		return ret
	}
	return *o.GitReferences
}

// GetGitReferencesOk returns a tuple with the GitReferences field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ScmRepositoryRelationships) GetGitReferencesOk() (*AnalyticsReportInstanceRelationshipsSegments, bool) {
	if o == nil || IsNil(o.GitReferences) {
		return nil, false
	}
	return o.GitReferences, true
}
...
// SetGitReferences gets a reference to the given AnalyticsReportInstanceRelationshipsSegments and assigns it to the GitReferences field.
...
// SetPullRequests gets a reference to the given AnalyticsReportInstanceRelationshipsSegments and assigns it to the PullRequests field.
...
func (o ScmRepositoryRelationships) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.GitReferences) {
		toSerialize["gitReferences"] = o.GitReferences
	}
