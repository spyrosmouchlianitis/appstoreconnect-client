...
type _SubscriptionAvailability SubscriptionAvailability
...
func (o *SubscriptionAvailability) UnmarshalJSON(data []byte) (err error) {
	...
	varSubscriptionAvailability := _SubscriptionAvailability{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSubscriptionAvailability)

	if err != nil {
		return err
	}

	*o = SubscriptionAvailability(varSubscriptionAvailability)
