...
type _GameCenterAppVersionsResponse GameCenterAppVersionsResponse
...
func (o *GameCenterAppVersionsResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varGameCenterAppVersionsResponse := _GameCenterAppVersionsResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGameCenterAppVersionsResponse)

	if err != nil {
		return err
	}

	*o = GameCenterAppVersionsResponse(varGameCenterAppVersionsResponse)
