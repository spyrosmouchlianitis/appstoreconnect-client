...
type _PromotedPurchaseImagesResponse PromotedPurchaseImagesResponse
...
func (o *PromotedPurchaseImagesResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varPromotedPurchaseImagesResponse := _PromotedPurchaseImagesResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPromotedPurchaseImagesResponse)

	if err != nil {
		return err
	}

	*o = PromotedPurchaseImagesResponse(varPromotedPurchaseImagesResponse)
