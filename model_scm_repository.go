...
type _ScmRepository ScmRepository
...
func (o *ScmRepository) UnmarshalJSON(data []byte) (err error) {
	...
	varScmRepository := _ScmRepository{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varScmRepository)

	if err != nil {
		return err
	}

	*o = ScmRepository(varScmRepository)
