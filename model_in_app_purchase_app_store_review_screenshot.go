...
type _InAppPurchaseAppStoreReviewScreenshot InAppPurchaseAppStoreReviewScreenshot
...
func (o *InAppPurchaseAppStoreReviewScreenshot) UnmarshalJSON(data []byte) (err error) {
	...
	varInAppPurchaseAppStoreReviewScreenshot := _InAppPurchaseAppStoreReviewScreenshot{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varInAppPurchaseAppStoreReviewScreenshot)

	if err != nil {
		return err
	}

	*o = InAppPurchaseAppStoreReviewScreenshot(varInAppPurchaseAppStoreReviewScreenshot)
