...
type _SubscriptionPricePointsResponse SubscriptionPricePointsResponse
...
func (o *SubscriptionPricePointsResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varSubscriptionPricePointsResponse := _SubscriptionPricePointsResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSubscriptionPricePointsResponse)

	if err != nil {
		return err
	}

	*o = SubscriptionPricePointsResponse(varSubscriptionPricePointsResponse)
