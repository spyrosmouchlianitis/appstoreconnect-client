...
func (o *BundleIdCapabilityCreateRequestDataAttributes) UnmarshalJSON(data []byte) (err error) {
	...
	err = decoder.Decode(&varBundleIdCapabilityCreateRequestDataAttributes)
