...
type ScmGitReferenceRelationships struct {
	Repository *ScmGitReferenceRelationshipsRepository `json:"repository,omitempty"`
}
...
func (o *ScmGitReferenceRelationships) GetRepository() ScmGitReferenceRelationshipsRepository {
	if o == nil || IsNil(o.Repository) {
		var ret ScmGitReferenceRelationshipsRepository
		return ret
	}
	return *o.Repository
}
...
// SetRepository gets a reference to the given ScmGitReferenceRelationshipsRepository and assigns it to the Repository field.
