...
type _AppClipDefaultExperienceLocalization AppClipDefaultExperienceLocalization
...
func (o *AppClipDefaultExperienceLocalization) UnmarshalJSON(data []byte) (err error) {
	...
	varAppClipDefaultExperienceLocalization := _AppClipDefaultExperienceLocalization{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAppClipDefaultExperienceLocalization)

	if err != nil {
		return err
	}

	*o = AppClipDefaultExperienceLocalization(varAppClipDefaultExperienceLocalization)
