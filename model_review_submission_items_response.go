...
type _ReviewSubmissionItemsResponse ReviewSubmissionItemsResponse
...
func (o *ReviewSubmissionItemsResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varReviewSubmissionItemsResponse := _ReviewSubmissionItemsResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varReviewSubmissionItemsResponse)

	if err != nil {
		return err
	}

	*o = ReviewSubmissionItemsResponse(varReviewSubmissionItemsResponse)
