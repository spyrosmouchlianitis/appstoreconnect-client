...
type _AppCustomProductPageLocalizationsResponse AppCustomProductPageLocalizationsResponse
...
func (o *AppCustomProductPageLocalizationsResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varAppCustomProductPageLocalizationsResponse := _AppCustomProductPageLocalizationsResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAppCustomProductPageLocalizationsResponse)

	if err != nil {
		return err
	}

	*o = AppCustomProductPageLocalizationsResponse(varAppCustomProductPageLocalizationsResponse)
