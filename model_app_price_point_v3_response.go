...
type _AppPricePointV3Response AppPricePointV3Response
...
func (o *AppPricePointV3Response) UnmarshalJSON(data []byte) (err error) {
	...
	varAppPricePointV3Response := _AppPricePointV3Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAppPricePointV3Response)

	if err != nil {
		return err
	}

	*o = AppPricePointV3Response(varAppPricePointV3Response)
