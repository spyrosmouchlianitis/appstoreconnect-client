...
type _GameCenterLeaderboardReleasesResponse GameCenterLeaderboardReleasesResponse
...
func (o *GameCenterLeaderboardReleasesResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varGameCenterLeaderboardReleasesResponse := _GameCenterLeaderboardReleasesResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGameCenterLeaderboardReleasesResponse)

	if err != nil {
		return err
	}

	*o = GameCenterLeaderboardReleasesResponse(varGameCenterLeaderboardReleasesResponse)
