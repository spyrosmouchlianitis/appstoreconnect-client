...
type _AppEventLocalizationRelationshipsAppEventData AppEventLocalizationRelationshipsAppEventData
...
func (o *AppEventLocalizationRelationshipsAppEventData) UnmarshalJSON(data []byte) (err error) {
	...
	varAppEventLocalizationRelationshipsAppEventData := _AppEventLocalizationRelationshipsAppEventData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAppEventLocalizationRelationshipsAppEventData)

	if err != nil {
		return err
	}

	*o = AppEventLocalizationRelationshipsAppEventData(varAppEventLocalizationRelationshipsAppEventData)
