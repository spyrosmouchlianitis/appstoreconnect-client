...
type _GameCenterMatchmakingRuleSetResponse GameCenterMatchmakingRuleSetResponse
...
func (o *GameCenterMatchmakingRuleSetResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varGameCenterMatchmakingRuleSetResponse := _GameCenterMatchmakingRuleSetResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGameCenterMatchmakingRuleSetResponse)

	if err != nil {
		return err
	}

	*o = GameCenterMatchmakingRuleSetResponse(varGameCenterMatchmakingRuleSetResponse)
