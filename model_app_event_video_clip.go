...
type _AppEventVideoClip AppEventVideoClip
...
func (o *AppEventVideoClip) UnmarshalJSON(data []byte) (err error) {
	...
	varAppEventVideoClip := _AppEventVideoClip{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAppEventVideoClip)

	if err != nil {
		return err
	}

	*o = AppEventVideoClip(varAppEventVideoClip)
