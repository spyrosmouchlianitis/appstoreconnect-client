...
type _SubscriptionSubmissionResponse SubscriptionSubmissionResponse
...
func (o *SubscriptionSubmissionResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varSubscriptionSubmissionResponse := _SubscriptionSubmissionResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSubscriptionSubmissionResponse)

	if err != nil {
		return err
	}

	*o = SubscriptionSubmissionResponse(varSubscriptionSubmissionResponse)
