...
type PromotedPurchaseImageRelationships struct {
	PromotedPurchase *PromotedPurchaseImageRelationshipsPromotedPurchase `json:"promotedPurchase,omitempty"`
}
...
func (o *PromotedPurchaseImageRelationships) GetPromotedPurchase() PromotedPurchaseImageRelationshipsPromotedPurchase {
	if o == nil || IsNil(o.PromotedPurchase) {
		var ret PromotedPurchaseImageRelationshipsPromotedPurchase
		return ret
	}
...
// SetPromotedPurchase gets a reference to the given PromotedPurchaseImageRelationshipsPromotedPurchase and assigns it to the PromotedPurchase field.
