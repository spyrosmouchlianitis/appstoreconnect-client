...
type _AppRelationshipsSubscriptionGracePeriodData AppRelationshipsSubscriptionGracePeriodData
...
func (o *AppRelationshipsSubscriptionGracePeriodData) UnmarshalJSON(data []byte) (err error) {
	...
	varAppRelationshipsSubscriptionGracePeriodData := _AppRelationshipsSubscriptionGracePeriodData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAppRelationshipsSubscriptionGracePeriodData)

	if err != nil {
		return err
	}

	*o = AppRelationshipsSubscriptionGracePeriodData(varAppRelationshipsSubscriptionGracePeriodData)
