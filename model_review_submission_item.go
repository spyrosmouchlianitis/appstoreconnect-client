...
type _ReviewSubmissionItem ReviewSubmissionItem
...
func (o *ReviewSubmissionItem) UnmarshalJSON(data []byte) (err error) {
	...
	varReviewSubmissionItem := _ReviewSubmissionItem{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varReviewSubmissionItem)

	if err != nil {
		return err
	}

	*o = ReviewSubmissionItem(varReviewSubmissionItem)
