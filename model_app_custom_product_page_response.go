...
type _AppCustomProductPageResponse AppCustomProductPageResponse
...
func (o *AppCustomProductPageResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varAppCustomProductPageResponse := _AppCustomProductPageResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAppCustomProductPageResponse)

	if err != nil {
		return err
	}

	*o = AppCustomProductPageResponse(varAppCustomProductPageResponse)
