...
type _SubscriptionLocalization SubscriptionLocalization
...
func (o *SubscriptionLocalization) UnmarshalJSON(data []byte) (err error) {
	...
	varSubscriptionLocalization := _SubscriptionLocalization{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSubscriptionLocalization)

	if err != nil {
		return err
	}

	*o = SubscriptionLocalization(varSubscriptionLocalization)
