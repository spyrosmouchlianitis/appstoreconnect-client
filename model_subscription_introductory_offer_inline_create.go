...
type _SubscriptionIntroductoryOfferInlineCreate SubscriptionIntroductoryOfferInlineCreate
...
func (o *SubscriptionIntroductoryOfferInlineCreate) UnmarshalJSON(data []byte) (err error) {
	...
	varSubscriptionIntroductoryOfferInlineCreate := _SubscriptionIntroductoryOfferInlineCreate{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSubscriptionIntroductoryOfferInlineCreate)

	if err != nil {
		return err
	}

	*o = SubscriptionIntroductoryOfferInlineCreate(varSubscriptionIntroductoryOfferInlineCreate)
