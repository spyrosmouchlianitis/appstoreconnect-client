...
type _AppPriceScheduleCreateRequestDataRelationships AppPriceScheduleCreateRequestDataRelationships
...
func (o *AppPriceScheduleCreateRequestDataRelationships) UnmarshalJSON(data []byte) (err error) {
	...
	varAppPriceScheduleCreateRequestDataRelationships := _AppPriceScheduleCreateRequestDataRelationships{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAppPriceScheduleCreateRequestDataRelationships)

	if err != nil {
		return err
	}

	*o = AppPriceScheduleCreateRequestDataRelationships(varAppPriceScheduleCreateRequestDataRelationships)
