...
type _SubscriptionSubmissionCreateRequest SubscriptionSubmissionCreateRequest
...
func (o *SubscriptionSubmissionCreateRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varSubscriptionSubmissionCreateRequest := _SubscriptionSubmissionCreateRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSubscriptionSubmissionCreateRequest)

	if err != nil {
		return err
	}

	*o = SubscriptionSubmissionCreateRequest(varSubscriptionSubmissionCreateRequest)
