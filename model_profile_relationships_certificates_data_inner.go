...
func (o *ProfileRelationshipsCertificatesDataInner) UnmarshalJSON(data []byte) (err error) {
	...
	varProfileRelationshipsCertificatesDataInner := _ProfileRelationshipsCertificatesDataInner{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varProfileRelationshipsCertificatesDataInner)

	if err != nil {
		return err
	}

	*o = ProfileRelationshipsCertificatesDataInner(varProfileRelationshipsCertificatesDataInner)
