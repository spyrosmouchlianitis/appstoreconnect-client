...
type _CiMacOsVersionResponse CiMacOsVersionResponse
...
func (o *CiMacOsVersionResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varCiMacOsVersionResponse := _CiMacOsVersionResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCiMacOsVersionResponse)

	if err != nil {
		return err
	}

	*o = CiMacOsVersionResponse(varCiMacOsVersionResponse)
