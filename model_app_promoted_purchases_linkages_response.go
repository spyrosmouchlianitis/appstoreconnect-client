...
type _AppPromotedPurchasesLinkagesResponse AppPromotedPurchasesLinkagesResponse
...
func (o *AppPromotedPurchasesLinkagesResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varAppPromotedPurchasesLinkagesResponse := _AppPromotedPurchasesLinkagesResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAppPromotedPurchasesLinkagesResponse)

	if err != nil {
		return err
	}

	*o = AppPromotedPurchasesLinkagesResponse(varAppPromotedPurchasesLinkagesResponse)
