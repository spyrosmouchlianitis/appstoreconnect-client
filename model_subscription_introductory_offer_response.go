...
type _SubscriptionIntroductoryOfferResponse SubscriptionIntroductoryOfferResponse
...
func (o *SubscriptionIntroductoryOfferResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varSubscriptionIntroductoryOfferResponse := _SubscriptionIntroductoryOfferResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSubscriptionIntroductoryOfferResponse)

	if err != nil {
		return err
	}

	*o = SubscriptionIntroductoryOfferResponse(varSubscriptionIntroductoryOfferResponse)
