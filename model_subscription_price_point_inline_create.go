...
type _SubscriptionPricePointInlineCreate SubscriptionPricePointInlineCreate
...
func (o *SubscriptionPricePointInlineCreate) UnmarshalJSON(data []byte) (err error) {
	...
	varSubscriptionPricePointInlineCreate := _SubscriptionPricePointInlineCreate{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSubscriptionPricePointInlineCreate)

	if err != nil {
		return err
	}

	*o = SubscriptionPricePointInlineCreate(varSubscriptionPricePointInlineCreate)
