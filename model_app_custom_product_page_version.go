...
type _AppCustomProductPageVersion AppCustomProductPageVersion
...
func (o *AppCustomProductPageVersion) UnmarshalJSON(data []byte) (err error) {
	...
	varAppCustomProductPageVersion := _AppCustomProductPageVersion{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAppCustomProductPageVersion)

	if err != nil {
		return err
	}

	*o = AppCustomProductPageVersion(varAppCustomProductPageVersion)
