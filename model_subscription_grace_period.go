...
type _SubscriptionGracePeriod SubscriptionGracePeriod
...
func (o *SubscriptionGracePeriod) UnmarshalJSON(data []byte) (err error) {
	...
	varSubscriptionGracePeriod := _SubscriptionGracePeriod{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSubscriptionGracePeriod)

	if err != nil {
		return err
	}

	*o = SubscriptionGracePeriod(varSubscriptionGracePeriod)
