...
type _AppEncryptionDeclarationDocumentUpdateRequest AppEncryptionDeclarationDocumentUpdateRequest
...
func (o *AppEncryptionDeclarationDocumentUpdateRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varAppEncryptionDeclarationDocumentUpdateRequest := _AppEncryptionDeclarationDocumentUpdateRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAppEncryptionDeclarationDocumentUpdateRequest)

	if err != nil {
		return err
	}

	*o = AppEncryptionDeclarationDocumentUpdateRequest(varAppEncryptionDeclarationDocumentUpdateRequest)
