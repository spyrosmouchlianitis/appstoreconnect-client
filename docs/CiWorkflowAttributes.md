...
`func (o *CiWorkflowAttributes) SetManualBranchStartCondition(v CiManualBranchStartCondition)`
...
`func (o *CiWorkflowAttributes) SetManualPullRequestStartCondition(v CiManualPullRequestStartCondition)`
