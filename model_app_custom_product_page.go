...
type _AppCustomProductPage AppCustomProductPage
...
func (o *AppCustomProductPage) UnmarshalJSON(data []byte) (err error) {
	...
	varAppCustomProductPage := _AppCustomProductPage{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAppCustomProductPage)

	if err != nil {
		return err
	}

	*o = AppCustomProductPage(varAppCustomProductPage)
