...
type _TerritoryInlineCreate TerritoryInlineCreate
...
func (o *TerritoryInlineCreate) UnmarshalJSON(data []byte) (err error) {
	...
	varTerritoryInlineCreate := _TerritoryInlineCreate{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varTerritoryInlineCreate)

	if err != nil {
		return err
	}

	*o = TerritoryInlineCreate(varTerritoryInlineCreate)
