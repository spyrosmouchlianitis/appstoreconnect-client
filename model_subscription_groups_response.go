...
type _SubscriptionGroupsResponse SubscriptionGroupsResponse
...
func (o *SubscriptionGroupsResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varSubscriptionGroupsResponse := _SubscriptionGroupsResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSubscriptionGroupsResponse)

	if err != nil {
		return err
	}

	*o = SubscriptionGroupsResponse(varSubscriptionGroupsResponse)
