...
type _InAppPurchaseContentResponse InAppPurchaseContentResponse
...
func (o *InAppPurchaseContentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varInAppPurchaseContentResponse := _InAppPurchaseContentResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varInAppPurchaseContentResponse)

	if err != nil {
		return err
	}

	*o = InAppPurchaseContentResponse(varInAppPurchaseContentResponse)
