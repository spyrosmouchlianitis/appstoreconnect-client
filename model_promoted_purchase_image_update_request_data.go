...
type _PromotedPurchaseImageUpdateRequestData PromotedPurchaseImageUpdateRequestData
...
func (o *PromotedPurchaseImageUpdateRequestData) UnmarshalJSON(data []byte) (err error) {
	...
	varPromotedPurchaseImageUpdateRequestData := _PromotedPurchaseImageUpdateRequestData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPromotedPurchaseImageUpdateRequestData)

	if err != nil {
		return err
	}

	*o = PromotedPurchaseImageUpdateRequestData(varPromotedPurchaseImageUpdateRequestData)
