...
type _CiBuildAction CiBuildAction
...
func (o *CiBuildAction) UnmarshalJSON(data []byte) (err error) {
	...
	varCiBuildAction := _CiBuildAction{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCiBuildAction)

	if err != nil {
		return err
	}

	*o = CiBuildAction(varCiBuildAction)
