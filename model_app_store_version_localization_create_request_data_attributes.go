...
func (o *AppStoreVersionLocalizationCreateRequestDataAttributes) UnmarshalJSON(data []byte) (err error) {
	...
	err = decoder.Decode(&varAppStoreVersionLocalizationCreateRequestDataAttributes)
