...
type _SubscriptionGroupLocalization SubscriptionGroupLocalization
...
func (o *SubscriptionGroupLocalization) UnmarshalJSON(data []byte) (err error) {
	...
	varSubscriptionGroupLocalization := _SubscriptionGroupLocalization{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSubscriptionGroupLocalization)

	if err != nil {
		return err
	}

	*o = SubscriptionGroupLocalization(varSubscriptionGroupLocalization)
