...
type _AppEventVideoClipCreateRequestDataAttributes AppEventVideoClipCreateRequestDataAttributes
...
func (o *AppEventVideoClipCreateRequestDataAttributes) UnmarshalJSON(data []byte) (err error) {
	...
	varAppEventVideoClipCreateRequestDataAttributes := _AppEventVideoClipCreateRequestDataAttributes{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAppEventVideoClipCreateRequestDataAttributes)

	if err != nil {
		return err
	}

	*o = AppEventVideoClipCreateRequestDataAttributes(varAppEventVideoClipCreateRequestDataAttributes)
