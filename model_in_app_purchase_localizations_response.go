...
type _InAppPurchaseLocalizationsResponse InAppPurchaseLocalizationsResponse
...
func (o *InAppPurchaseLocalizationsResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varInAppPurchaseLocalizationsResponse := _InAppPurchaseLocalizationsResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varInAppPurchaseLocalizationsResponse)

	if err != nil {
		return err
	}

	*o = InAppPurchaseLocalizationsResponse(varInAppPurchaseLocalizationsResponse)
