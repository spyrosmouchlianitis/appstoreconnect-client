...
type _ScmRepositoriesResponse ScmRepositoriesResponse
...
func (o *ScmRepositoriesResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varScmRepositoriesResponse := _ScmRepositoriesResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varScmRepositoriesResponse)

	if err != nil {
		return err
	}

	*o = ScmRepositoriesResponse(varScmRepositoriesResponse)
