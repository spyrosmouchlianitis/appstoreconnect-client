...
type _SubscriptionPromotionalOfferPricesResponse SubscriptionPromotionalOfferPricesResponse
...
func (o *SubscriptionPromotionalOfferPricesResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varSubscriptionPromotionalOfferPricesResponse := _SubscriptionPromotionalOfferPricesResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSubscriptionPromotionalOfferPricesResponse)

	if err != nil {
		return err
	}

	*o = SubscriptionPromotionalOfferPricesResponse(varSubscriptionPromotionalOfferPricesResponse)
