...
type _ScmPullRequestResponse ScmPullRequestResponse
...
func (o *ScmPullRequestResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varScmPullRequestResponse := _ScmPullRequestResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varScmPullRequestResponse)

	if err != nil {
		return err
	}

	*o = ScmPullRequestResponse(varScmPullRequestResponse)
