...
type AppStoreVersionAttributes struct {
	...
	AppVersionState *AppVersionState `json:"appVersionState,omitempty"`
...
// GetAppVersionState returns the AppVersionState field value if set, zero value otherwise.
func (o *AppStoreVersionAttributes) GetAppVersionState() AppVersionState {
	if o == nil || IsNil(o.AppVersionState) {
		var ret AppVersionState
		return ret
	}
	return *o.AppVersionState
}

// GetAppVersionStateOk returns a tuple with the AppVersionState field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AppStoreVersionAttributes) GetAppVersionStateOk() (*AppVersionState, bool) {
	if o == nil || IsNil(o.AppVersionState) {
		return nil, false
	}
	return o.AppVersionState, true
}
...
// SetAppVersionState gets a reference to the given AppVersionState and assigns it to the AppVersionState field.
...
func (o AppStoreVersionAttributes) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.AppVersionState) {
		toSerialize["appVersionState"] = o.AppVersionState
	}
