...
type InAppPurchaseRelationships struct {
	Apps *InAppPurchaseRelationshipsApps `json:"apps,omitempty"`
}
...
func (o *InAppPurchaseRelationships) GetApps() InAppPurchaseRelationshipsApps {
	if o == nil || IsNil(o.Apps) {
		var ret InAppPurchaseRelationshipsApps
		return ret
	}
	return *o.Apps
}
...
// SetApps gets a reference to the given InAppPurchaseRelationshipsApps and assigns it to the Apps field.
