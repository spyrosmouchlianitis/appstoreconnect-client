...
type _CiXcodeVersionsResponse CiXcodeVersionsResponse
...
func (o *CiXcodeVersionsResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varCiXcodeVersionsResponse := _CiXcodeVersionsResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCiXcodeVersionsResponse)

	if err != nil {
		return err
	}

	*o = CiXcodeVersionsResponse(varCiXcodeVersionsResponse)
