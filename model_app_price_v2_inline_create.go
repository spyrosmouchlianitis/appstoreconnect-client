...
type _AppPriceV2InlineCreate AppPriceV2InlineCreate
...
func (o *AppPriceV2InlineCreate) UnmarshalJSON(data []byte) (err error) {
	...
	varAppPriceV2InlineCreate := _AppPriceV2InlineCreate{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAppPriceV2InlineCreate)

	if err != nil {
		return err
	}

	*o = AppPriceV2InlineCreate(varAppPriceV2InlineCreate)
