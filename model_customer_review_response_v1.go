...
type _CustomerReviewResponseV1 CustomerReviewResponseV1
...
func (o *CustomerReviewResponseV1) UnmarshalJSON(data []byte) (err error) {
	...
	varCustomerReviewResponseV1 := _CustomerReviewResponseV1{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCustomerReviewResponseV1)

	if err != nil {
		return err
	}

	*o = CustomerReviewResponseV1(varCustomerReviewResponseV1)
