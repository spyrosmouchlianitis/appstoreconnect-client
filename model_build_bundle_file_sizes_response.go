...
type _BuildBundleFileSizesResponse BuildBundleFileSizesResponse
...
func (o *BuildBundleFileSizesResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varBuildBundleFileSizesResponse := _BuildBundleFileSizesResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varBuildBundleFileSizesResponse)

	if err != nil {
		return err
	}

	*o = BuildBundleFileSizesResponse(varBuildBundleFileSizesResponse)
