...
type _AppRelationshipsReviewSubmissionsDataInner AppRelationshipsReviewSubmissionsDataInner
...
func (o *AppRelationshipsReviewSubmissionsDataInner) UnmarshalJSON(data []byte) (err error) {
	...
	varAppRelationshipsReviewSubmissionsDataInner := _AppRelationshipsReviewSubmissionsDataInner{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAppRelationshipsReviewSubmissionsDataInner)

	if err != nil {
		return err
	}

	*o = AppRelationshipsReviewSubmissionsDataInner(varAppRelationshipsReviewSubmissionsDataInner)
