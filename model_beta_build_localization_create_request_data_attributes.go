...
func (o *BetaBuildLocalizationCreateRequestDataAttributes) UnmarshalJSON(data []byte) (err error) {
	...
	err = decoder.Decode(&varBetaBuildLocalizationCreateRequestDataAttributes)
