...
type _SubscriptionPricesResponse SubscriptionPricesResponse
...
func (o *SubscriptionPricesResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varSubscriptionPricesResponse := _SubscriptionPricesResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSubscriptionPricesResponse)

	if err != nil {
		return err
	}

	*o = SubscriptionPricesResponse(varSubscriptionPricesResponse)
