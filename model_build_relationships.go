...
type BuildRelationships struct {
	...
	DiagnosticSignatures *AnalyticsReportInstanceRelationshipsSegments `json:"diagnosticSignatures,omitempty"`
}
...
// GetDiagnosticSignatures returns the DiagnosticSignatures field value if set, zero value otherwise.
func (o *BuildRelationships) GetDiagnosticSignatures() AnalyticsReportInstanceRelationshipsSegments {
	if o == nil || IsNil(o.DiagnosticSignatures) {
		var ret AnalyticsReportInstanceRelationshipsSegments
		return ret
	}
	return *o.DiagnosticSignatures
}

// GetDiagnosticSignaturesOk returns a tuple with the DiagnosticSignatures field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *BuildRelationships) GetDiagnosticSignaturesOk() (*AnalyticsReportInstanceRelationshipsSegments, bool) {
	if o == nil || IsNil(o.DiagnosticSignatures) {
		return nil, false
	}
	return o.DiagnosticSignatures, true
}
...
// SetDiagnosticSignatures gets a reference to the given AnalyticsReportInstanceRelationshipsSegments and assigns it to the DiagnosticSignatures field.
func (o *BuildRelationships) SetDiagnosticSignatures(v AnalyticsReportInstanceRelationshipsSegments) {
	o.DiagnosticSignatures = &v
}
...
func (o BuildRelationships) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.DiagnosticSignatures) {
		toSerialize["diagnosticSignatures"] = o.DiagnosticSignatures
	}
