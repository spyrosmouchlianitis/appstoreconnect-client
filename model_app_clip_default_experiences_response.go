...
type _AppClipDefaultExperiencesResponse AppClipDefaultExperiencesResponse
...
func (o *AppClipDefaultExperiencesResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varAppClipDefaultExperiencesResponse := _AppClipDefaultExperiencesResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAppClipDefaultExperiencesResponse)

	if err != nil {
		return err
	}

	*o = AppClipDefaultExperiencesResponse(varAppClipDefaultExperiencesResponse)
