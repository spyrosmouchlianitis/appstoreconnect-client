...
type _AppClipDefaultExperienceUpdateRequestData AppClipDefaultExperienceUpdateRequestData
...
func (o *AppClipDefaultExperienceUpdateRequestData) UnmarshalJSON(data []byte) (err error) {
	...
	varAppClipDefaultExperienceUpdateRequestData := _AppClipDefaultExperienceUpdateRequestData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAppClipDefaultExperienceUpdateRequestData)

	if err != nil {
		return err
	}

	*o = AppClipDefaultExperienceUpdateRequestData(varAppClipDefaultExperienceUpdateRequestData)
