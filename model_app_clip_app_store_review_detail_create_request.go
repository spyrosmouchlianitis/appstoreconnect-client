...
type _AppClipAppStoreReviewDetailCreateRequest AppClipAppStoreReviewDetailCreateRequest
...
func (o *AppClipAppStoreReviewDetailCreateRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varAppClipAppStoreReviewDetailCreateRequest := _AppClipAppStoreReviewDetailCreateRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAppClipAppStoreReviewDetailCreateRequest)

	if err != nil {
		return err
	}

	*o = AppClipAppStoreReviewDetailCreateRequest(varAppClipAppStoreReviewDetailCreateRequest)
