...
type _InAppPurchasePricePointsResponse InAppPurchasePricePointsResponse
...
func (o *InAppPurchasePricePointsResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varInAppPurchasePricePointsResponse := _InAppPurchasePricePointsResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varInAppPurchasePricePointsResponse)

	if err != nil {
		return err
	}

	*o = InAppPurchasePricePointsResponse(varInAppPurchasePricePointsResponse)
