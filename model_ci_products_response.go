...
type _CiProductsResponse CiProductsResponse
...
func (o *CiProductsResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varCiProductsResponse := _CiProductsResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCiProductsResponse)

	if err != nil {
		return err
	}

	*o = CiProductsResponse(varCiProductsResponse)
