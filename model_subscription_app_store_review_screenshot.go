...
type _SubscriptionAppStoreReviewScreenshot SubscriptionAppStoreReviewScreenshot
...
func (o *SubscriptionAppStoreReviewScreenshot) UnmarshalJSON(data []byte) (err error) {
	...
	varSubscriptionAppStoreReviewScreenshot := _SubscriptionAppStoreReviewScreenshot{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSubscriptionAppStoreReviewScreenshot)

	if err != nil {
		return err
	}

	*o = SubscriptionAppStoreReviewScreenshot(varSubscriptionAppStoreReviewScreenshot)
