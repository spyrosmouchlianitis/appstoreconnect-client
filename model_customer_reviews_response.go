...
type _CustomerReviewsResponse CustomerReviewsResponse
...
func (o *CustomerReviewsResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varCustomerReviewsResponse := _CustomerReviewsResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCustomerReviewsResponse)

	if err != nil {
		return err
	}

	*o = CustomerReviewsResponse(varCustomerReviewsResponse)
