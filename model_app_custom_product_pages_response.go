...
type _AppCustomProductPagesResponse AppCustomProductPagesResponse
...
func (o *AppCustomProductPagesResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varAppCustomProductPagesResponse := _AppCustomProductPagesResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAppCustomProductPagesResponse)

	if err != nil {
		return err
	}

	*o = AppCustomProductPagesResponse(varAppCustomProductPagesResponse)
