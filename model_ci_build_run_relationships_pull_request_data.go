...
type _CiBuildRunRelationshipsPullRequestData CiBuildRunRelationshipsPullRequestData
...
func (o *CiBuildRunRelationshipsPullRequestData) UnmarshalJSON(data []byte) (err error) {
	...
	varCiBuildRunRelationshipsPullRequestData := _CiBuildRunRelationshipsPullRequestData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCiBuildRunRelationshipsPullRequestData)

	if err != nil {
		return err
	}

	*o = CiBuildRunRelationshipsPullRequestData(varCiBuildRunRelationshipsPullRequestData)
