...
type _AppCustomProductPageLocalizationCreateRequest AppCustomProductPageLocalizationCreateRequest
...
func (o *AppCustomProductPageLocalizationCreateRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varAppCustomProductPageLocalizationCreateRequest := _AppCustomProductPageLocalizationCreateRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAppCustomProductPageLocalizationCreateRequest)

	if err != nil {
		return err
	}

	*o = AppCustomProductPageLocalizationCreateRequest(varAppCustomProductPageLocalizationCreateRequest)
