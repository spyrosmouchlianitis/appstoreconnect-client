...
type _GameCenterGroupsResponse GameCenterGroupsResponse
...
func (o *GameCenterGroupsResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varGameCenterGroupsResponse := _GameCenterGroupsResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGameCenterGroupsResponse)

	if err != nil {
		return err
	}

	*o = GameCenterGroupsResponse(varGameCenterGroupsResponse)
