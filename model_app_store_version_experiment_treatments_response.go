...
type _AppStoreVersionExperimentTreatmentsResponse AppStoreVersionExperimentTreatmentsResponse
...
func (o *AppStoreVersionExperimentTreatmentsResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varAppStoreVersionExperimentTreatmentsResponse := _AppStoreVersionExperimentTreatmentsResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAppStoreVersionExperimentTreatmentsResponse)

	if err != nil {
		return err
	}

	*o = AppStoreVersionExperimentTreatmentsResponse(varAppStoreVersionExperimentTreatmentsResponse)
