...
type _ScmPullRequest ScmPullRequest
...
func (o *ScmPullRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varScmPullRequest := _ScmPullRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varScmPullRequest)

	if err != nil {
		return err
	}

	*o = ScmPullRequest(varScmPullRequest)
