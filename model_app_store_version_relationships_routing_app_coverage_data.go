...
func (o *AppStoreVersionRelationshipsRoutingAppCoverageData) UnmarshalJSON(data []byte) (err error) {
	...
	err = decoder.Decode(&varAppStoreVersionRelationshipsRoutingAppCoverageData)
