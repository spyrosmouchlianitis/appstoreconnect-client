...
type _SubscriptionPromotionalOfferInlineCreate SubscriptionPromotionalOfferInlineCreate
...
func (o *SubscriptionPromotionalOfferInlineCreate) UnmarshalJSON(data []byte) (err error) {
	...
	varSubscriptionPromotionalOfferInlineCreate := _SubscriptionPromotionalOfferInlineCreate{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSubscriptionPromotionalOfferInlineCreate)

	if err != nil {
		return err
	}

	*o = SubscriptionPromotionalOfferInlineCreate(varSubscriptionPromotionalOfferInlineCreate)
