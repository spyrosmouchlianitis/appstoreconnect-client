...
type _AppClipAdvancedExperienceCreateRequestData AppClipAdvancedExperienceCreateRequestData
...
func (o *AppClipAdvancedExperienceCreateRequestData) UnmarshalJSON(data []byte) (err error) {
	...
	varAppClipAdvancedExperienceCreateRequestData := _AppClipAdvancedExperienceCreateRequestData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAppClipAdvancedExperienceCreateRequestData)

	if err != nil {
		return err
	}

	*o = AppClipAdvancedExperienceCreateRequestData(varAppClipAdvancedExperienceCreateRequestData)
