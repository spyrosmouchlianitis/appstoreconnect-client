...
type _BetaLicenseAgreementResponse BetaLicenseAgreementResponse
...
func (o *BetaLicenseAgreementResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varBetaLicenseAgreementResponse := _BetaLicenseAgreementResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varBetaLicenseAgreementResponse)

	if err != nil {
		return err
	}

	*o = BetaLicenseAgreementResponse(varBetaLicenseAgreementResponse)
