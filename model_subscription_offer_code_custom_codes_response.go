...
type _SubscriptionOfferCodeCustomCodesResponse SubscriptionOfferCodeCustomCodesResponse
...
func (o *SubscriptionOfferCodeCustomCodesResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varSubscriptionOfferCodeCustomCodesResponse := _SubscriptionOfferCodeCustomCodesResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSubscriptionOfferCodeCustomCodesResponse)

	if err != nil {
		return err
	}

	*o = SubscriptionOfferCodeCustomCodesResponse(varSubscriptionOfferCodeCustomCodesResponse)
