...
type _SubscriptionOfferCodePricesResponse SubscriptionOfferCodePricesResponse
...
func (o *SubscriptionOfferCodePricesResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varSubscriptionOfferCodePricesResponse := _SubscriptionOfferCodePricesResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSubscriptionOfferCodePricesResponse)

	if err != nil {
		return err
	}

	*o = SubscriptionOfferCodePricesResponse(varSubscriptionOfferCodePricesResponse)
