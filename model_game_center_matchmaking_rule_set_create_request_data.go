...
type _GameCenterMatchmakingRuleSetCreateRequestData GameCenterMatchmakingRuleSetCreateRequestData
...
func (o *GameCenterMatchmakingRuleSetCreateRequestData) UnmarshalJSON(data []byte) (err error) {
	...
	varGameCenterMatchmakingRuleSetCreateRequestData := _GameCenterMatchmakingRuleSetCreateRequestData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGameCenterMatchmakingRuleSetCreateRequestData)

	if err != nil {
		return err
	}

	*o = GameCenterMatchmakingRuleSetCreateRequestData(varGameCenterMatchmakingRuleSetCreateRequestData)
