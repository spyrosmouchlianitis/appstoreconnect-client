...
type _CiWorkflowRelationshipsMacOsVersionData CiWorkflowRelationshipsMacOsVersionData
...
func (o *CiWorkflowRelationshipsMacOsVersionData) UnmarshalJSON(data []byte) (err error) {
	...
	varCiWorkflowRelationshipsMacOsVersionData := _CiWorkflowRelationshipsMacOsVersionData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCiWorkflowRelationshipsMacOsVersionData)

	if err != nil {
		return err
	}

	*o = CiWorkflowRelationshipsMacOsVersionData(varCiWorkflowRelationshipsMacOsVersionData)
