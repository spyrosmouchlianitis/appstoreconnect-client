...
type _CiBuildRunCreateRequestData CiBuildRunCreateRequestData
...
func (o *CiBuildRunCreateRequestData) UnmarshalJSON(data []byte) (err error) {
	...
	varCiBuildRunCreateRequestData := _CiBuildRunCreateRequestData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCiBuildRunCreateRequestData)

	if err != nil {
		return err
	}

	*o = CiBuildRunCreateRequestData(varCiBuildRunCreateRequestData)
