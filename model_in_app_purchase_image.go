...
// checks if the InAppPurchaseImage type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InAppPurchaseImage{}

// InAppPurchaseImage struct for InAppPurchaseImage
type InAppPurchaseImage struct {
	Type string `json:"type"`
	Id string `json:"id"`
	Attributes *InAppPurchaseImageAttributes `json:"attributes,omitempty"`
	Relationships *InAppPurchaseImageRelationships `json:"relationships,omitempty"`
	Links *ResourceLinks `json:"links,omitempty"`
}

type _InAppPurchaseImage InAppPurchaseImage
...
func (o *InAppPurchaseImage) GetRelationships() InAppPurchaseImageRelationships {
	if o == nil || IsNil(o.Relationships) {
		var ret InAppPurchaseImageRelationships
		return ret
	}
...
// SetRelationships gets a reference to the given InAppPurchaseImageRelationships and assigns it to the Relationships field.
...
func (o InAppPurchaseImage) MarshalJSON() ([]byte, error) {
...
func (o InAppPurchaseImage) ToMap() (map[string]interface{}, error) {
...
func (o *InAppPurchaseImage) UnmarshalJSON(data []byte) (err error) {
	...
	varInAppPurchaseImage := _InAppPurchaseImage{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varInAppPurchaseImage)

	if err != nil {
		return err
	}

	*o = InAppPurchaseImage(varInAppPurchaseImage)

	return err
}

type NullableInAppPurchaseImage struct {
	value *InAppPurchaseImage
	isSet bool
}

func (v NullableInAppPurchaseImage) Get() *InAppPurchaseImage {
	return v.value
}

func (v *NullableInAppPurchaseImage) Set(val *InAppPurchaseImage) {
	v.value = val
	v.isSet = true
}

func (v NullableInAppPurchaseImage) IsSet() bool {
	return v.isSet
}

func (v *NullableInAppPurchaseImage) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInAppPurchaseImage(val *InAppPurchaseImage) *NullableInAppPurchaseImage {
	return &NullableInAppPurchaseImage{value: val, isSet: true}
}

func (v NullableInAppPurchaseImage) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInAppPurchaseImage) UnmarshalJSON(src []byte) error {
	v.isSet = true
