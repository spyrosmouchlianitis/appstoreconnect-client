...
type _SubscriptionOfferCodeUpdateRequestData SubscriptionOfferCodeUpdateRequestData
...
func (o *SubscriptionOfferCodeUpdateRequestData) UnmarshalJSON(data []byte) (err error) {
	...
	varSubscriptionOfferCodeUpdateRequestData := _SubscriptionOfferCodeUpdateRequestData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSubscriptionOfferCodeUpdateRequestData)

	if err != nil {
		return err
	}

	*o = SubscriptionOfferCodeUpdateRequestData(varSubscriptionOfferCodeUpdateRequestData)
