...
type _SubscriptionOfferCodeOneTimeUseCodeUpdateRequest SubscriptionOfferCodeOneTimeUseCodeUpdateRequest
...
func (o *SubscriptionOfferCodeOneTimeUseCodeUpdateRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varSubscriptionOfferCodeOneTimeUseCodeUpdateRequest := _SubscriptionOfferCodeOneTimeUseCodeUpdateRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSubscriptionOfferCodeOneTimeUseCodeUpdateRequest)

	if err != nil {
		return err
	}

	*o = SubscriptionOfferCodeOneTimeUseCodeUpdateRequest(varSubscriptionOfferCodeOneTimeUseCodeUpdateRequest)
