...
type _GameCenterLeaderboardSetResponse GameCenterLeaderboardSetResponse
...
func (o *GameCenterLeaderboardSetResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varGameCenterLeaderboardSetResponse := _GameCenterLeaderboardSetResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGameCenterLeaderboardSetResponse)

	if err != nil {
		return err
	}

	*o = GameCenterLeaderboardSetResponse(varGameCenterLeaderboardSetResponse)
