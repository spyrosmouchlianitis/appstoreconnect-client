...
type _AppClipAdvancedExperiencesResponse AppClipAdvancedExperiencesResponse
...
func (o *AppClipAdvancedExperiencesResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varAppClipAdvancedExperiencesResponse := _AppClipAdvancedExperiencesResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAppClipAdvancedExperiencesResponse)

	if err != nil {
		return err
	}

	*o = AppClipAdvancedExperiencesResponse(varAppClipAdvancedExperiencesResponse)
