...
type _AppEventScreenshotUpdateRequestData AppEventScreenshotUpdateRequestData
...
func (o *AppEventScreenshotUpdateRequestData) UnmarshalJSON(data []byte) (err error) {
	...
	varAppEventScreenshotUpdateRequestData := _AppEventScreenshotUpdateRequestData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAppEventScreenshotUpdateRequestData)

	if err != nil {
		return err
	}

	*o = AppEventScreenshotUpdateRequestData(varAppEventScreenshotUpdateRequestData)
