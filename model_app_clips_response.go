...
type _AppClipsResponse AppClipsResponse
...
func (o *AppClipsResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varAppClipsResponse := _AppClipsResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAppClipsResponse)

	if err != nil {
		return err
	}

	*o = AppClipsResponse(varAppClipsResponse)
