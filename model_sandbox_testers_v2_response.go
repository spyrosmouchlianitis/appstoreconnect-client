...
type _SandboxTestersV2Response SandboxTestersV2Response
...
func (o *SandboxTestersV2Response) UnmarshalJSON(data []byte) (err error) {
	...
	varSandboxTestersV2Response := _SandboxTestersV2Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSandboxTestersV2Response)

	if err != nil {
		return err
	}

	*o = SandboxTestersV2Response(varSandboxTestersV2Response)
