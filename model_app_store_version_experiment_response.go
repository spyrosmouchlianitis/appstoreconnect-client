...
type _AppStoreVersionExperimentResponse AppStoreVersionExperimentResponse
...
func (o *AppStoreVersionExperimentResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varAppStoreVersionExperimentResponse := _AppStoreVersionExperimentResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAppStoreVersionExperimentResponse)

	if err != nil {
		return err
	}

	*o = AppStoreVersionExperimentResponse(varAppStoreVersionExperimentResponse)
