...
type _ReviewSubmission ReviewSubmission
...
func (o *ReviewSubmission) UnmarshalJSON(data []byte) (err error) {
	...
	varReviewSubmission := _ReviewSubmission{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varReviewSubmission)

	if err != nil {
		return err
	}

	*o = ReviewSubmission(varReviewSubmission)
