...
type _AppClipAdvancedExperienceLocalization AppClipAdvancedExperienceLocalization
...
func (o *AppClipAdvancedExperienceLocalization) UnmarshalJSON(data []byte) (err error) {
	...
	varAppClipAdvancedExperienceLocalization := _AppClipAdvancedExperienceLocalization{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAppClipAdvancedExperienceLocalization)

	if err != nil {
		return err
	}

	*o = AppClipAdvancedExperienceLocalization(varAppClipAdvancedExperienceLocalization)
