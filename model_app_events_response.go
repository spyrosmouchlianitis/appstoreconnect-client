...
type _AppEventsResponse AppEventsResponse
...
func (o *AppEventsResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varAppEventsResponse := _AppEventsResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAppEventsResponse)

	if err != nil {
		return err
	}

	*o = AppEventsResponse(varAppEventsResponse)
