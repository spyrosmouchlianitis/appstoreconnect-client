...
// checks if the MarketplaceSearchDetail type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MarketplaceSearchDetail{}

// MarketplaceSearchDetail struct for MarketplaceSearchDetail
...
type _MarketplaceSearchDetail MarketplaceSearchDetail
...
func (o MarketplaceSearchDetail) MarshalJSON() ([]byte, error) {
...
func (o MarketplaceSearchDetail) ToMap() (map[string]interface{}, error) {
...
func (o *MarketplaceSearchDetail) UnmarshalJSON(data []byte) (err error) {
	...
	varMarketplaceSearchDetail := _MarketplaceSearchDetail{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varMarketplaceSearchDetail)

	if err != nil {
		return err
	}

	*o = MarketplaceSearchDetail(varMarketplaceSearchDetail)

	return err
}

type NullableMarketplaceSearchDetail struct {
	value *MarketplaceSearchDetail
	isSet bool
}

func (v NullableMarketplaceSearchDetail) Get() *MarketplaceSearchDetail {
	return v.value
}

func (v *NullableMarketplaceSearchDetail) Set(val *MarketplaceSearchDetail) {
	v.value = val
	v.isSet = true
}

func (v NullableMarketplaceSearchDetail) IsSet() bool {
	return v.isSet
}

func (v *NullableMarketplaceSearchDetail) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMarketplaceSearchDetail(val *MarketplaceSearchDetail) *NullableMarketplaceSearchDetail {
	return &NullableMarketplaceSearchDetail{value: val, isSet: true}
}

func (v NullableMarketplaceSearchDetail) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMarketplaceSearchDetail) UnmarshalJSON(src []byte) error {
	v.isSet = true
