...
type _CustomerReviewResponse CustomerReviewResponse
...
func (o *CustomerReviewResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varCustomerReviewResponse := _CustomerReviewResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCustomerReviewResponse)

	if err != nil {
		return err
	}

	*o = CustomerReviewResponse(varCustomerReviewResponse)
