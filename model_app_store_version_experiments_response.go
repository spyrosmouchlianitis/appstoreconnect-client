...
type _AppStoreVersionExperimentsResponse AppStoreVersionExperimentsResponse
...
func (o *AppStoreVersionExperimentsResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varAppStoreVersionExperimentsResponse := _AppStoreVersionExperimentsResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAppStoreVersionExperimentsResponse)

	if err != nil {
		return err
	}

	*o = AppStoreVersionExperimentsResponse(varAppStoreVersionExperimentsResponse)
