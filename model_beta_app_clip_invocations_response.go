...
type _BetaAppClipInvocationsResponse BetaAppClipInvocationsResponse
...
func (o *BetaAppClipInvocationsResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varBetaAppClipInvocationsResponse := _BetaAppClipInvocationsResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varBetaAppClipInvocationsResponse)

	if err != nil {
		return err
	}

	*o = BetaAppClipInvocationsResponse(varBetaAppClipInvocationsResponse)
