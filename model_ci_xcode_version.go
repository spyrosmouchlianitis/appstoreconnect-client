...
type _CiXcodeVersion CiXcodeVersion
...
func (o *CiXcodeVersion) UnmarshalJSON(data []byte) (err error) {
	...
	varCiXcodeVersion := _CiXcodeVersion{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCiXcodeVersion)

	if err != nil {
		return err
	}

	*o = CiXcodeVersion(varCiXcodeVersion)
